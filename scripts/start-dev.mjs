 ...
 *
 * Serves the app same-origin against a DHIS2 instance — by default one on
 * http://localhost:8080; point it elsewhere with DHIS2_PROXY_TARGET.
 * It sets DHIS2_BASE_URL to the dev server's own
